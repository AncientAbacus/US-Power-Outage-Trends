...
For this project, we decided to look at a dataset that summarized all major power outages in the continental United States. We used this website to download the data:  <br>
https://engineering.purdue.edu/LASCI/research-data/outages/outagerisks
 <br />
We refered to this link for variable definitions:  <br />
